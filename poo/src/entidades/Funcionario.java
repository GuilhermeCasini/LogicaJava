...
public class Funcionario {
	...
	public String toString() {
		...
		if (desligamento == null)
			return "\n"+nome+", prontuario "+id+" trabalha desde "+f.format(dataAdmissao)+", há "+tempoServico(dataAdmissao)
			+" anos, com salario atual de R$"+String.format("%.2f", salario)
			+".\n";
		
		else 
			return "\n"+nome+", prontuario "+id+" trabalhou de "+f.format(dataAdmissao)+", a "+f.format(desligamento)
			+" e seu ultimo salario foi de R$"+String.format("%.2f", salario)
			+".\n";
	}
